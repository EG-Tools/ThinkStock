...
import { collectAiRuntimeFiles } from "./ai-runtime-boundary.mjs";
...
const APPROVED_RUNTIME_SHA256 = Object.freeze({
  ...
  "shared/ai-context-classifier.mjs": "0713995b77607e84a8e2368ad5533fc57dc5814b29bf8fba49a2950053ca9145",
  "shared/runtime-foundation.mjs": "b41a3c5468148e70b0dc4ac07d462360df50bc7dc563b721e789a5441d156f9e",
});
...
async function changedRuntimeFiles(runtimeFiles) {
...
const runtimeFiles = await collectAiRuntimeFiles(root);
const [runtimeSource, summary, comparison, changed] = await Promise.all([
  ...
  changedRuntimeFiles(runtimeFiles),
]);
