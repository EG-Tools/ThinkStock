...
const ENGINE_PATH = path.join(ROOT, "docs", "modules", "ai-forecast.js");
  ...
  for (const anchor of anchorsFor(points)) {
    ...
    HORIZONS.forEach((horizon) => {
      ...
      observations.push({
        ...
        modelKind: forecast.model?.horizons?.find((value) => value.days === horizon)?.kind || "",
...
const report = {
  ...
  sourceCoverage: {
    ...
    pointInTimeConsensus: false,
    pointInTimeFinancials: false,
    pointInTimeDisclosures: false,
    genericInternetNews: false,
