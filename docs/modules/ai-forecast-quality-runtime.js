(function initThinkStockAiForecastQualityRuntime(globalScope) {
  "use strict";
  ...
  function createAiForecastQualityRuntime(scope = globalScope, options = {}) {
  ...
  globalScope.ThinkStockAiForecastQualityRuntime = Object.freeze({
