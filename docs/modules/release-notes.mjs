  ...
  const RELEASES = Object.freeze([
    ...
    Object.freeze({
      ...
      items: Object.freeze([
        ...
        "새 거래일 확인 시 최근 확정 이력을 다시 대조해 장중 임시 종가와 신호 자동 교정",
        "Windows·배포 서버의 줄바꿈 차이와 무관하게 동일한 기능 번들 생성",
      ]),
    }),
    Object.freeze({
      version: "3.50",
      ...
      items: Object.freeze([
        ...
        "이전 빌드의 저장 화면이 최신 뉴스심리 데이터를 가리는 부팅 문제 수정",
    ...
    Object.freeze({
      ...
      date: "2026.09.09",
      items: Object.freeze([
        "AI 예측 기록 저장 주소에 종목코드 계약 통일",
        "서버 저장 실패 기록의 재등록 복구",
        "이전 설명 근거가 없는 전망의 비교 근거 부족 표시",
      ]),
    }),
    Object.freeze({
      version: "3.46",
