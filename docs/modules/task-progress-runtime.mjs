import { createProgressView } from "./control-state-view.mjs";
...
function createTaskProgress(scope = globalThis, options = {}) {
  ...
  const createView = options.createProgressView || createProgressView;
  const view = createView(scope, { getRoot, getText, getBar });
  const tasks = new Map();
  let revealTimer = 0;
  let hideTimer = 0;
  let sessionAnchor = "";
...
export { createDisclosureProgress, createTaskProgress };
